...
PHPMAILER_PORT="${PHPMAILER_PORT}"
PHPMAILER_USERNAME="${PHPMAILER_USERNAME}"
PHPMAILER_PASSWORD="${PHPMAILER_PASSWORD}"
PHPMAILER_ENCRYPTION="${PHPMAILER_ENCRYPTION}"
PHPMAILER_FROM_ADDRESS="${PHPMAILER_FROM_ADDRESS}"
PHPMAILER_FROM_NAME="${PHPMAILER_FROM_NAME}"
